...
public class PlayerMoveStats : ScriptableObject
{
    ...
    private StatFloat _maxSpeed = 2.0f;
    ...
    [SerializeField] private StatFloat _maxGroundAngle = new(45);

    [Header("Jumping")] [SerializeField] private StatFloat _jumpHeight = 5.0f;
    ...
    [Header("Gravity")] [SerializeField] private StatFloat _maxFallSpeed = 7.5f;
    ...
    private LayerMask _groundLayer = Physics2D.DefaultRaycastLayers;
    ...
    // Stat values
    public StatFloat MaxSpeed
    {
        get => _maxSpeed;
        private set => _maxSpeed = value;
    }

    public StatFloat Acceleration
    {
        get => _acceleration;
        private set => _acceleration = value;
    }

    public StatFloat Drag
    {
        get => _drag;
        private set => _drag = value;
    }

    public StatFloat JumpHeight
    {
        get => _jumpHeight;
        private set => _jumpHeight = value;
    }

    public StatFloat JumpSpeed
    {
        get => _jumpSpeed;
        private set => _jumpSpeed = value;
    }

    public StatInt MidairJumps
    {
        get => _midairJumps;
        private set => _midairJumps = value;
    }

    public StatFloat Gravity { get; private set; }

    public StatFloat MaxFallSpeed
    {
        get => _maxFallSpeed;
        private set => _maxFallSpeed = value;
    }

    public StatFloat MaxGroundAngle
    {
        get => _maxGroundAngle;
        private set => _maxGroundAngle = value;
    }

    // Modifiers
    public StatOverride<float> AerialMaxSpeed
    {
        get => _aerialMaxSpeed;
        private set => _aerialMaxSpeed = value;
    }

    public StatMultiplier RunSpeed
    {
        get => _runSpeedMult;
        private set => _runSpeedMult = value;
    }

    public StatOverride<float> AerialAcceleration
    {
        get => _aerialAcceleration;
        private set => _aerialAcceleration = value;
    }

    public StatOverride<float> AerialDrag
    {
        get => _aerialDrag;
        private set => _aerialDrag = value;
    }

    public StatOverride<float> AerialJumpHeight
    {
        get => _aerialJumpHeight;
        private set => _aerialJumpHeight = value;
    }

    public StatDecrease MidairJumpsUsed { get; private set; }

    public StatMultiplier FallingGravity
    {
        get => _fallingGravityMult;
        private set => _fallingGravityMult = value;
    }

    public StatMultiplier FastFallSpeed
    {
        get => _fastFallMult;
        private set => _fastFallMult = value;
    }

    // Other Values
    public float JumpCancelFactor
    {
        get => _jumpCancelFactor;
        set => _jumpCancelFactor = value;
    }
    ...
    public Rect FloorDetectionArea
    {
        get => _floorDetectionArea;
        set => _floorDetectionArea = value;
    }
    ...
    public Rect CeilingDetectionArea
    {
        get => _ceilingDetectionArea;
        set => _ceilingDetectionArea = value;
    }
